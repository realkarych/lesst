...
auth-emails_count_limit_exceeded = Ты не можешь добавить новый Email. В твоем тарифе можно добавить максимум { $max_emails_count } Email-адрес(ов).

                                   — Чтобы добавить новый Email, удали один из подключенных ранее. Для этого нажми кнопку "Мои Ящики"
                                   — Если ты хочешь повысить лимиты, кнопку "Подписка"
auth-no_added_emails = У тебя нет добавленных Email-ящиков
...
forum-topic_send_email = Написать письмо
