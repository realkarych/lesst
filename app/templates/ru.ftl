...
forum-group_added = ✔️ Группа успешно добавлена. В течение нескольких минут в боковую панель будут подгружаться письма.
                    Чем больше у тебя писем, тем дольше будет процесс.

                    <i>Ты можешь выйти из чата, загрузка не прервется. По окончании придет уведомление от бота в личные сообщения</i>
